...
class UserServiceImplementationTest {
    ...
    @Test
    void whenUpdatingThenReturnSuccess() {
        when(repository.save(any())).thenReturn(user);
    ...
    @Test
    void whenUpdatingThenReturnAnDataIntegrityViolationException() {
//        when(repository.save(any())).thenReturn(user);
        when(repository.findByEmail(anyString())).thenThrow(new DataIntegrityViolationException(EMAIL_JA_CADASTRADO_NO_SISTEMA));
